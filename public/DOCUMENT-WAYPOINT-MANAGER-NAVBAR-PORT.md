...
| **Asset** | `public/Union-2.svg` (white plus on transparent; colored via CSS mask) |
...
Plus icon (24×24 viewBox). Icon color is **not** in the SVG for the navbar — use CSS mask + `background-color: #d9d9d9`.
